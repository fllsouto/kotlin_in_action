...
class SecurityConfiguration(
    ...
    override fun configure(auth: AuthenticationManagerBuilder) {
        ...
        val queryUsers = "select username, password, enabled from domain_user where username=?"
        val queryRoles = "select u.username, r.roles from user_roles r, domain_user u where r.user_id = u.id and u.username=?"
